...
const page = () => {
  return (
    <section className='flex flex-col justify-center items-center min-h-screen bg-background px-4 py-16 md:py-32'>
        <div className='flex flex-row justify-center items-center gap-x-2'>
         <h1 className='text-3xl font-extrabold text-foreground'>Welcome to</h1>
         <Image src={"/t3logo.svg"} alt='logo' width={142} height={142}/>
        </div>
